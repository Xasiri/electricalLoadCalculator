...
const TrayValidation = ({ trayData, cableCalculatedData }) => {
  ...
  let CalculatedDepthofCableTray =
    trayData.layers * trayData.run * cableCalculatedData.cableDepth;
  let actualWeightofCables =
    trayData.layers * trayData.run * cableCalculatedData.cableWeight;
  let remainingCableTrayWidth = (
    (1 - cableCalculatedData.cableWidth / trayData.width) *
    100
  ).toFixed(2);
  let remainingCableTrayArea = (
    (1 - cableCalculatedData.cableArea / actualCableTrayArea) *
    100
  ).toFixed(2);
    ...
    <>
      ...
      <Row className="my-2">
        ...
        <Col lg="5">
          ...
          actualWeightofCables < trayData.weight
            ? ok
            : notOk}
        </Col>
      </Row>
